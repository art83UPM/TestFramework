        ...
        case 0:
            do {
                try {
                    ...
                    System.out.println("Ha introducido un valor de un tipo diferente al esperado en la fila " + this.getDataAccess().getRow() + " - columna " + this.getDataAccess().getColumn() + ". Se esperaba un carácter 'x'.");
                    System.exit(0);
                }catch (InvalidDataAccessError e) {
                    System.out.println("Debe introducir 'x' o 'X' en la fila " + this.getDataAccess().getRow() + " - columna " + this.getDataAccess().getColumn() + ".");
                    System.exit(0);
                }
            } while (!captured);
            return true;
        case 1:            
            do {
                try {
                    ...
                    System.out.println("Ha introducido un valor de un tipo diferente al esperado en la fila " + this.getDataAccess().getRow() + " - columna " + this.getDataAccess().getColumn() + ". Se esperaba un número entero.");
                    System.exit(0);
                }
            } while (!captured);
            return true;
